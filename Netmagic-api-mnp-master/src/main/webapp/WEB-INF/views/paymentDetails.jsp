...
<script language="JavaScript" type="text/javascript">
	...
	function checkit() {
		...
		<body onLoad="document.order.submit()"
			...
			<form action="${paymentsubmiturl}" method="post" name="order" />
			<center>
				<input type="hidden" id="amount" name="amount" readonly="readonly"
					value="${amount}" />

				<div style="background-color: white; display: none;">

					<input type="hidden" name="v3URL" value="${paymenturl}" />
					<div>
						...
						<table width="700" style="text-align: left;">
							...
							<tr>
								...
								<td align="left"><input type="hidden" id="account_id"
									name="account_id" value="6463" /></td>
								<tr>
									<td>NMIT Account<span class="red">*</span></td>
									<td align="left"><input type="hidden" id="B6463BB9"
										name="B6463BB9" value="${nmitTotal}" /></td>
									<td>NMSPL Account<span class="red">*</span></td>
									<td align="left"><input type="hidden" id="B646346F"
										name="B646346F" value="${nmsplTotal}" /></td>
									<td>Split profile code<span class="red">*</span></td>
									<td align="left"><input type="hidden"
										id="split_profile_code" name="split_profile_code" value="" /></td>
									<tr>
									...
									<tr>
										<td class="fieldName" width="50%">Currency<span
											class="red">*</span></td>
									...
									<tr>
										...
										<td align="left"><input type="hidden" id="return_url"
											name="return_url" value="${returnurl}" /></td>
										<tr>
											<tr>
												<td>Mode<span class="red">*</span></td>
												<td align="left"><input id="mode" name="mode"
													type="hidden" value="${paymentMode}" readonly="true" /></td>
											</tr>
											...
											<tr>
												...
												<td align="left"><input type="hidden" id="reference_no"
													name="reference_no" value="${referenceid}" /></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td align="left" width="50%"><input id="description"
													name="description" type="hidden" value="asas" /></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td align="left"><select name="country" id="country">
														...
														<option value="COD">Congo, the Democratic
														...
														<option value="MKD">Macedonia, the former
														...
														<option value="PSE">Palestinian Territory,
															Occupied</option>
											...
											<tr>
												...
												<td align="left"><input id="ship_phone"
													name="ship_phone" type="hidden" value="${shipMobile}" /></td>
											</tr>
											<tr>
												<td>Ship Postal Code<span class="red">*</span></td>
												<td align="left"><input id="ship_postal_code"
													name="ship_postal_code" type="hidden"
													value="${shipPinCode}" /></td>
											</tr>
											...
											<tr>
												<td valign="top" align="center" colspan="2"><input
													value="Reset" type="reset" id="reset" /></td>
											</tr>
						</table>
					</div>
