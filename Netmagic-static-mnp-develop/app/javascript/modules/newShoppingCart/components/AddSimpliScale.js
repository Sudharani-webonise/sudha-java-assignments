...
var AddSimpliScale = createReactClass({
	render () {
		return (
        ...
        <form className="buyOptionForm">
            ...
            <div className="simplyScaleMembersListWrap">
              ...
              <ul className="clearfix">
                <li className="memberListHeadingWrap clearfix">
                  ...
                  <div className="vmUseTemplateWrap">Use as Template</div>
                </li>
                <li className="clearfix">
                  ...
                  <div className="vmUseTemplateWrap">
                    <input type="radio"/>
                  </div>
                  <div className="rootPassword">
          ...
          <div className="col-md-6 buyBorder padTop20 clearfix addVmConfigWrap">
            ...
            <div className="maxDynamicWrap clearfix">
              <div className="customSelectGroup clearfix pull-left">
                <label for="serviceTerm">Max No. of Dynamic Instances <span className="mandatoryStar">*</span></label>
                <ul className="customSelectList mandatory dropDownData ticketCustomList customer">
                  <li>1</li>
                  <li>2</li>
                  <li>3</li>
              ...
              <div className="infopara pull-left clearfix">
                <p>This value selected is the max. no. of new instances that would be created during the scale-up process.</p>
              </div>
            </div>
            ...
            <div className="executeCommandsWrap">
              <h5 className="sectionSubHeading">Execute Commands on VM’s created during Scale-up</h5>
              <a className="blueBorderBtn" href="javascript:void(0)">+  Add Commands</a>
            </div>
            <div className="maxDynamicWrap clearfix vmPublicIPWrap">
              <div className="customSelectGroup clearfix pull-left">
                <label for="serviceTerm">VM Public IP</label>
                <ul className="customSelectList mandatory dropDownData ticketCustomList customer">
                  <li>No SNAT</li>
                </ul>
                <p className="selectContent"></p>
              ...
              <div className="infopara pull-left clearfix">
                <p>Select the required Firewall Rules to be added for every VM created during Scale-up. </p>
              </div>
              <div className="clearfix"></div>
            </div>
            <a className="blueBorderBtn addFirewallPolicyBtn" href="javascript:void(0)">+  Add Firewall Policy</a>
          </div>
