...
module.exports = {
    ...
    module: {
        loaders: [
            ...
            {
                test: /\.css/,
                loader: 'style-loader!css-loader?name=theme/default/stylesheets/[name]-[hash].[ext]'
            },
            { test: /\.pdf$/, loader: 'file-loader?name=theme/default/pdf/[name].[ext]' },
            { test: /\.png|jpg|gif$/, loader: 'file-loader?name=theme/default/images/[name].[ext]' },
            {
                test: /\.sass$/,
    ...
    plugins: [
        ...
        new ExtractTextPlugin('theme/default/stylesheets/[name]-[hash].min.css'),
        ...
        new CopyWebpackPlugin([
            ...
            {
                from: path.join(rootPath, 'app/theme/default/pdf'),
                to: 'theme/default/pdf'
            },
        ]),
